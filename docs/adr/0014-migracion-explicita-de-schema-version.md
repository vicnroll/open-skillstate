...
- `skstate check` detecta el desajuste y dice qué hacer.
- `skstate migrate` migra de forma explícita, dejando copia de seguridad del estado anterior.
